...
def generate_train_images():
    sequencesIntron = getSequences("../sequenceData/generator/introns.txt")
    sequencesExon = getSequences("../sequenceData/generator/exon.txt")
...
def generate_test_mixed_images():
    mixedSequences = getSequences("../sequenceData/generator/1_exon_5000_length.txt")
    level = 5
